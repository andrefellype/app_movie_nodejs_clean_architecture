...
class TvShowEpisodeRouter {
    ...
    private deleteSeveral() {
        return this.routes.post('/tvshowepisode/delete/several', body('_ids').notEmpty(), this.verifyJWT, TvShowEpisodeController.deleteSeveral)
    }

    private delete() {
        return this.routes.post('/tvshowepisode/delete', body('tvShowEpisodeId').notEmpty(), this.verifyJWT, TvShowEpisodeController.delete)
    }

    private approved() {
        return this.routes.post('/tvshowepisode/approved/reviewed', body('tvShowEpisodeId').notEmpty(), this.verifyJWT, TvShowEpisodeController.approved)
    }
    ...
    private update() {
        ...
        return this.routes.post('/tvshowepisode/update', body('tvShowEpisodeId').notEmpty(), body('tvShowSeasonId').notEmpty(),
            ...
            }), this.verifyJWT, TvShowEpisodeController.update)
    }
